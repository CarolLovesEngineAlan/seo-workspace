...
- The page narrative is: "{primary_keyword} is a remarkable model — and it's now accessible through Pexo"
...
- **H1**: the model name as H1, short — suggest a `<br>` split point with a note. Must contain primary keyword.
...
- **sources_html**: HTML anchor links for all 4 models in the comparison (subject + 3 competitors)
...
- Cover: what the model is, key differentiators, standout capabilities, how to access it, whether it's free, use case fit
